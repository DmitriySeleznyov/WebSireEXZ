<%@ Page Title="Система дистанционного мониторинга и управления ЭХЗ - Регистрация" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>
                        Длина пароля не должна быть менее чем <%= Membership.MinRequiredPasswordLength %> знаков.
                    </p>
                        ...
                        <fieldset class="register">
                            ...
                            <p>
                                <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email" 
                                    Width="128px">Електрона пошта:</asp:Label>
                            </p>
                            <p>
                            ...
                            <p>
                                <asp:Label ID="ConfirmPasswordLabel" runat="server" 
                                    AssociatedControlID="ConfirmPassword" Width="133px">Підтвердіть пароль:</asp:Label>
                            </p>
                            <p>
