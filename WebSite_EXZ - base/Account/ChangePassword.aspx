<%@ Page Title="Система дистанционного мониторинга и управления ЭХЗ - Изменение пароля" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Используйте следующую форму для изменения своего пароля
    </p>
    <p>
        Длина нового пароля не должна быть меньше <%= Membership.MinRequiredPasswordLength %> знаков.
    </p>
    <asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/" EnableViewState="false" RenderOuterTable="false" 
         SuccessPageUrl="ChangePasswordSuccess.aspx" DisplayUserName="True">
                ...
                <fieldset class="changePassword">
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="ConfirmNewPasswordRequired" runat="server" ControlToValidate="ConfirmNewPassword" 
                             CssClass="failureNotification" Display="Dynamic" ErrorMessage="Поле ''Подтвердите новый пароль'' является обязательным."
